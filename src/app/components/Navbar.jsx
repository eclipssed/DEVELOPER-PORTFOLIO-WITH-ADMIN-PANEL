  ...
  return (
    <nav
      className={`z-10 relative ${
        isSticky
          ? "sticky top-0 left-0 right-0 border-b border-b-[#33353f] bg-[#121212] bg-opacity-80"
          : ""
      }`}
    >
      <div
      ...
      >
        ...
        <div className="md:hidden ">
          <div
            onClick={toggleMenu}
            className="text-[#adb7be] focus:outline-none focus:text-gray-500"
          >
            {isMenuOpen ? (
      ...
      <div className="md:hidden block text-center">
        {isMenuOpen && (
          <div
            className={` bg-[#121212] w-full bg-opacity-70 ${
              isMenuOpen ? "border-b" : ""
            } absolute p-4 z-10`}
          >
            {isMenuOpen && (
